...
* In [Javascript](/docs/getting_started/javascript-tests) and [Typescript](/docs/getting_started/typescript-tests), for exercising your contracts from the outside world, just like your application.
